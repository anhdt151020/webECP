...
<div class="right_col" role="main">
	<div class="">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2 style="margin-right: 20px;"><a href="<c:url value="/goods-receipt/add"/>" class="btn btn-app"><i class="fa fa-plus"></i>Add</a></h2>
					<h2 style="margin-right: 20px;"><a href="<c:url value="/goods-receipt/export"/>" class="btn btn-app"><i class="fa fa-cloud-download"></i>Export</a></h2>
					<h1>Goods Receipt</h1>
					<div class="clearfix"></div>
				</div>
				<div class="x_content">
...
<script type="text/javascript">
	 ...
	 function confirmChange(id, flag) {
		 ...
		 if (confirm(msg)) {
			 window.location.href = '<c:url value="/goods-receipt/change-status/"/>' + id;
		 }
	 }

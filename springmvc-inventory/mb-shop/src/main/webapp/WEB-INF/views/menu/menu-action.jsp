		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						<br />
						<form:form modelAttribute="mAuth" cssClass="form-horizontal form-label-left" servletRelativeAction="/menu/update-permission" method="POST">
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="roleId">Role <span class="required">*</span> </label>
							...
							<div class="form-group">
								<label for="menuId" class="control-label col-md-3 col-sm-3 col-xs-12">Menu Url</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="permission"> Permission</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">

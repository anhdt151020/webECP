...
<div class="container body">
    <div class="main_container">
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="/index" class="site_title"><i class="fa fa-paw"></i> <span>MB-Shop</span></a>
                </div>
                ...
                <!-- sidebar menu -->
                <titles:insertAttribute name="sidebar"/>
                <!-- /sidebar menu -->
        ...
        <!-- top navigation -->
        <titles:insertAttribute name="top-nav"/>
        <!-- /top navigation -->

...
insert into news(title, categoryid) values ('Bai viet 4',2);
insert into news(title, categoryid) values ('Bai viet 5',2);
insert into news(title, categoryid) values ('Bai viet 6',1);
insert into news(title, categoryid) values ('Bai viet 7',2);

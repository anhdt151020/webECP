...
<div class="right_col" role="main">
    <div class="">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2 style="margin-right: 20px;"><a href="<c:url value="/goods-issue/add"/>" class="btn btn-app"><i class="fa fa-plus"></i>Add</a></h2>
                    <h2 style="margin-right: 20px;"><a href="<c:url value="/goods-issue/export"/>" class="btn btn-app"><i class="fa fa-cloud-download"></i>Export</a></h2>
                    <h1>Goods Issue</h1>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                        ...
                        <form:form modelAttribute="searchForm" cssClass="form-horizontal form-label-left" servletRelativeAction="/goods-issue/list/1" method="POST">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                       for="productInfoByProductId.code">Product Code </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="fromDate">From
                                    Date</label>
                                <div class="col-md-6 col-sm-6 col-xs-12 ">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped jambo_table bulk_action">
                            ...
                            <tr class="headings">
                                ...
                                <th class="column-title">Active/Process</th>
                            ...
                            <c:forEach items="${invoices}" var="invoice" varStatus="loop">
                                ...
                                <td class=" ">${invoice.productInfoByProductId.code }</td>
                                <td class=" ">${invoice.code }</td>
                                <td class="date">${invoice.modifiedDate}</td>
                                <td class=" ">${invoice.price }</td>
                                <td class=" ">${invoice.qty }</td>
                                <c:choose>
                                    <c:when test="${invoice.activeFlag==1}">
                                        <td><a href="javascript:void(0);"
                                               onclick="confirmChange(${invoice.id},${invoice.activeFlag});" class="btn
...
<script type="text/javascript">
    ...
    function confirmChange(id, flag) {
        var msg = flag == 1 ? 'Do you want process this invoice ?' : 'Do you want active this invoice ?';
        if (confirm(msg)) {
            window.location.href = '<c:url value="/goods-issue/change-status/"/>' + id;
        }
    }

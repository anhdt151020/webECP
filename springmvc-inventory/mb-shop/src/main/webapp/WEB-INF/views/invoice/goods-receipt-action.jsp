		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						<br />
						<form:form modelAttribute="mInvoice" cssClass="form-horizontal form-label-left" servletRelativeAction="/goods-receipt/save" method="POST">
							<form:hidden path="id" />
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="code">Invoice Code <span class="required">*</span>
								</label>
								...
								<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="productId">Product Code<span class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<c:choose>
										...
										<c:otherwise>
											<form:input path="productInfoByProductId.code" disabled="true" cssClass="form-control col-md-7 col-xs-12"/>
										</c:otherwise>
									</c:choose>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<form:input path="qty" cssClass="form-control col-md-7 col-xs-12" disabled="${checkActive}" />
									<div class="has-error">
							...
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="code">History Description<span
											class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">

...
<div class="right_col" role="main">
    <div class="">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2 style="margin-right: 20px;"><a href="<c:url value="/role/add"/>" class="btn btn-app"><i
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped jambo_table bulk_action">
                            ...
                            <c:forEach items="${roles}" var="role" varStatus="loop">
                                ...
                                <td class="text-center"><a href="<c:url value="/role/view/${role.id }"/>"
                                                           class="btn btn-round btn-default">View</a></td>
                                <td class="text-center"><a href="<c:url value="/role/edit/${role.id }"/>"

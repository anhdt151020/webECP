        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br/>
                        <form:form modelAttribute="mProductInfo" cssClass="form-horizontal form-label-left"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <form:input path="categoryByCateId.code" disabled="true"
                            ...
                            <c:choose>
                                <c:when test="${!viewOnly}">
                                    <div class="form-group">
                                        <label for="multipartFile" class="control-label col-md-3 col-sm-3 col-xs-12">Image
                                            Upload</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <form:input path="multipartFile" cssClass="form-control col-md-7 col-xs-12"
                                                        type="file"/>
                                            <div class="has-error">
                                ...
                                <c:otherwise>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <img src="<c:url value="/resources/picture/${mProductInfo.imgUrl}"/>" width="200px" height="200px"/>
                                        </div>
                                    </div>
                                </c:otherwise>
                            </c:choose>

...
<!-- main-content -->
    <div class="main-content">
        <form action="<c:url value="/admin/news/list?page=${model.page}&limit=${model.limit}"/> " id="formSubmit" method="get">
                    ...
                    <div class="row" >
                        <div class="col-xs-12">
                                ...
                                <div class="table-btn-controls">
                                    <div class="pull-right tableTools-container">
                                        <div class="dt-buttons btn-overlap btn-group">
                                            ...
                                            <button onclick="warningBeforeDelete()" id="btnDelete" type="button" class="dt-button buttons-html5 btn btn-white btn-primary btn-bold" data-toggle="tooltip" title='Xóa bài viết' >
																<span>
                            ...
                            <div class="table-responsive">
                                ...
                                <%--id="page" để ở dưới hàm gọi #page, value là gtri của nó--%>
    ...
    function warningBeforeDelete() {
        ...
        function deleteNew(data) {
            $.ajax({
                ...
                success: function () {
                    window.location.href = "${newEditURL}?page=1&limit=2&message=delete_success";
                },
                error: function () {
                    window.location.href = "${newEditURL}?page=1&limit=2&message=error_system";
                }
            });
        }
    }

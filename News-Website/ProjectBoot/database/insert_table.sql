...
insert into new(title, category_id) values ('Bai viet 1',1);
insert into new(title, category_id) values ('Bai viet 2',1);
insert into new(title, category_id) values ('Bai viet 3',2);
insert into new(title, category_id) values ('Bai viet 4',2);
insert into new(title, category_id) values ('Bai viet 5',2);
insert into new(title, category_id) values ('Bai viet 6',1);
insert into new(title, category_id) values ('Bai viet 7',2);
